...
export default function Register() {
  ...
  const validateFormInput = (event) => {
    ...
    if (!formInput.email) { // how to validate the email
      setFormError({
        ...inputError,
        email: "Enter valid email address",
      });
    ...
    if (formInput.confirmPassword !== formInput.password) { // need to use it but not sure how
      setFormError({
        ...inputError,
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden max-w-md w-full">
        ...
        <div className="px-6 py-8">
          ...
          <div className="mb-4">
            ...
            <div className="mb-4 flex px-2 content-between">
               <div className="mr-4">
                <label for="Major" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Major</label>
                  <select id="Major" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-300 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                     <option>-Major-</option>
                     <option>CS</option>
                     <option>SE</option>
                  </select>
               ...
               <select id="Year" placeholder="-Year-" class="bg-grey-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-300 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                   <option>-year-</option>
            ...
            <div className="mb-4">
              <label
                for="repeat-password" className="block mb-2 font-semibold text-gray-800"
                htmlFor="password"
              >
                Repeat Password
              </label>
